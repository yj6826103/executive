<template><!--航班查询-->
	<div class="flightList">
            ...
            <div class="rbox">
                <div class="infobox">
                    <div class="rbbq">
                        ...
                        <div class="cen">
                            <input type="text"  @keyup="toUpperCase('flgtFlightNo')" v-model="itfFlgt.flgtFlightNo" class="text" placeholder="请输入出港航班号" />
                        </div>
                    </div>
                    <div class="rbbq">
                        <div class="tit"><i class="el-icon-caret-right gray"></i>飞机注册号</div>
                        <div class="cen">
                            <input type="text"  @keyup="toUpperCase('flgtRegCode')" v-model="itfFlgt.flgtRegCode" class="text" placeholder="请输入飞机注册号"/>
                        </div>
                    </div>
                    <div class="rbbq">
                        <div class="tit"><i class="el-icon-caret-right gray"></i>机型</div>
                        <div class="cen">
                            <input type="text"  @keyup="toUpperCase('flgtActypeCode')" v-model="itfFlgt.flgtActypeCode" class="text" placeholder="请输入飞机型号" />
                        </div>
                    </div>
                    <div class="rbbq">
                        <div class="tit"><i class="el-icon-caret-right gray"></i>代理公司</div>
                        <div class="cen">
                           <el-input type="text" v-model="itfFlgt.flgtAgentCom" class="text" placeholder="请输入代理公司" clearable></el-input>
                        </div>
                    </div>
                ...
                <div class="infobox">
                    ...
                    <div class="rbbq">
                        <div class="tit"><i class="el-icon-caret-right gray"></i>计划日期(开始)</div>
                        <div class="cen">
                    ...
                    <div class="rbbq">
                        <div class="tit"><i class="el-icon-caret-right gray"></i>计划日期(结束)</div>
                        <div class="cen">
                            <el-date-picker :clearable='true'
                ...
                <div class="infobox">
                    ...
                    <div class="rbbq marginB0">
                        ...
                        <div class="cen">
                            <input type="text" v-model="itfFlgt.flgtDCityCode" class="text" placeholder="请输入出发地" 
                    ...
                    <div class="rbbq marginB0" >
                        ...
                        <div class="cen">
                            <input type="text" v-model="itfFlgt.flgtACityCode" class="text" placeholder="请输入目的地"
        ...
        <div class="box table-box">
             <el-table border class="table table-border table-bg" :data="list" stripe style="width:100%;margin-bottom:0;">
                ...
                <el-table-column prop="flgtRegCode" label="飞机注册号" min-width="90"></el-table-column>
                ...
                <el-table-column prop="flgtCrew" label="机组"></el-table-column>
                <el-table-column prop="flgtPassenger" label="客人"></el-table-column>
            </el-table>
...
export default {
  ...
  methods: {
      toUpperCase(item){//小写变大写
            this.itfFlgt[item]=this.itfFlgt[item].toUpperCase()
        },
    clear() {
