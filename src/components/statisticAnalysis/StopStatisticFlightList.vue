		...
		<div class="yanqiBox">
            ...
            <div class="box table-box" style=" padding-bottom: 10px;">
                <el-table class="table table-border table-bg" :data="dataList" stripe border>
                    ...
                    <el-table-column prop="fmSta" label="进港运行占用（进港时间）"  min-width="120px"></el-table-column>
                    ...
                    <el-table-column prop="fmStaRa" label="进港停场占用（进港运行释放）" min-width="120px" ></el-table-column>
                    <el-table-column prop="fmParkingStnd" label="进港停场机位" ></el-table-column>
                    <el-table-column prop="fmStdRa" label="出港停场释放（出港运行占用）" min-width="120px"></el-table-column>
                    ...
                    <el-table-column prop="fmStd" label="出港运行释放（出港时间）"  min-width="120px"></el-table-column>
