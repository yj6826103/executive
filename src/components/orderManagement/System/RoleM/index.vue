            ...
            <div class="rbox minrbox">
                <div class="infobox">
                    <div class="rbbq">
                        ...
                        <div class="cen">
                            <input type="text" v-model="roleName" @keyup="toUpperCase" class="text" placeholder="请输入角色名称">
                        </div>
                    </div>
                    <div class="flexOld">
                        <el-button type="primary" icon="el-icon-search"  @click="getData">查询</el-button>
                        <el-button style="margin-left: 10px;" icon="el-icon-plus" type="warning" plain @click="add">增加</el-button>
                    </div>
                </div>
                
                <el-table class="table table-border table-bg" :data="list">
                    <el-table-column prop="roleName" label="角色名称" ></el-table-column>
                    <el-table-column prop="arpt" label="所属机场"></el-table-column>
                    ...
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            ...
                            <el-button class="butv" icon="el-icon-rank" @click="selectMenu(scope.row)" >关联</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
