  ...
  <div class="dict">
    <el-form :model="dict" border :rules="rules" ref="dict" label-width="100px">
      ...
      <el-form-item label="停场时限:" prop="ptlTimeLimit">
        <el-input-number style="width:230px;border:1px solid #ccc" v-model="dict.ptlTimeLimit" :controls="false"></el-input-number>
      </el-form-item>
      <el-form-item label="警告时限：" prop="ptlWarnLimit">
        <el-input-number style="width:230px;border:1px solid #ccc" v-model="dict.ptlWarnLimit" :controls="false"></el-input-number>
      </el-form-item>
      <el-form-item label="违约时限:" prop="ptlBocLimit">
        <el-input-number style="width:230px;border:1px solid #ccc" v-model="dict.ptlBocLimit" :controls="false"></el-input-number>
      </el-form-item>
...
export default {
  ...
  data() {
    ...
    ptlComBases: [
      ...
      rules: {
        ptlTimeLimit: [{ required: true, message: '必填项', trigger: 'blur' }],
        ptlWarnLimit: [{ required: true, message: '必填项', trigger: 'blur' }],
        ptlBocLimit: [{ required: true, message: '必填项', trigger: 'blur' }]
      }
    }
  },
  mounted() {
