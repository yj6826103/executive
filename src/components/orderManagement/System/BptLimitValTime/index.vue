   ...
   <div class="ygbox">
         ...
         <div class="tableBox">
            <el-table class="table table-border table-bg" :data="page.list" stripe>
                ...
                <el-table-column   prop="ptlComBase"  label="公司类别"  > </el-table-column>
                <el-table-column prop="ptlTimeLimit" label="停场时限(H)"></el-table-column>
                <el-table-column prop="ptlWarnLimit" label="警告时限(H)"></el-table-column>
                <el-table-column prop="ptlBocLimit" label="违约时限(H)" ></el-table-column>
                <el-table-column prop="actypeType" label="预订类型" >
                  <template slot-scope="scope">
                   {{scope.row.actypeType == '1' ? '创建预订':'延期停场'}}
                  </template>
                </el-table-column>
                <el-table-column prop="arpt" label="所属机场">
                  <template slot-scope="scope">
                ...
                <el-table-column label="操作">
                  <template slot-scope="scope">
                    ...
                    <el-button type="danger" style="padding:5px" @click="changeStatus(scope.row.ptlId,'0')" v-if="scope.row.ptlStatus == '1'" disabled>禁用</el-button>
                  </template>
                </el-table-column>
            </el-table>
          </div> 
          ...
          <el-dialog :title="dialogTitle" 
                ...
                :before-close='close'
                width="420px">
                <DictTime v-if="showDialog" :oldDict="dict"></DictTime>
            </el-dialog>
        </div>
</template>
