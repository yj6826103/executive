<template>
	<div class="modify"><!--修改订单-->
	    <div class="createOrderBox">
            ...
            <div class="tit gray"><i class="el-icon-caret-right gray"></i>{{$t('msg.AirRoutetype')}}</div>
				...
				<li>
					<div class="rbbq" :class="errClassed?errClass:''">
						...
						<div class="cen">
							<input type="text" disabled style="background:none;width:100%" class="inputText" v-model="orderStay" readonly="readonly" placeholder="—————">
						</div>
					</div>
				</li>
			</ul>
          ...
          <div class="validateStyle"><span v-show="errors.has('orderArptCode')" class="help is-danger">{{ errors.first('orderArptCode') }}</span></div>
              ...
              <el-cascader class="cen21" disabled :options="FLGTTYPE_CODE" :props="orderFlgttypeCode" v-model="orderFlgttypeCodes" @change="FLGTTYPE_CODE_Change" separator=">" placeholder="———————"></el-cascader>
          </div>
          <div class="validateStyle"></div>
					<div class="rbbq disabled">
						...
						<div class="cenMission">
							<div class="ddlb" style="height:23px">
    ...
    <el-dialog :title="$t('Selectorder')"
        ...
        <Bounced ref="Bounceds" v-if="selectFalse" :message="status" @setSelectFalse='set_selectFalse' @initRWXZs="initRWXZ"></Bounced>
    </el-dialog>
   <!-- 余量查询 -->
    <el-dialog 
