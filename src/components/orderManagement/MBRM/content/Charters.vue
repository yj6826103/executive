        ...
        <div class="tit">
            ...
            <el-dropdown trigger="click" :showTimeout="0"  placement="bottom-start">
                ...
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item>
                        <i @click="Add_Hangar(0)" class="el-icon-circle-plus i_icon"> 增加机坪</i>
                    </el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
        </div>
                ...
                <li v-for="(item,index) in AddHangars">
                    <div class="tit">
                        ...
                        <el-dropdown trigger="click" :show-timeout='0'  placement="bottom-start">
                            ...
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item>
                                    <i class="el-icon-circle-plus-outline i_icon" @click="add_reservation(item.stndObjectName,item.stndObjectId,item,index,0)"> 添加机位</i>
                                </el-dropdown-item>
                                <el-dropdown-item><i class="el-icon-edit-outline" @click="mod_Hangar(item,0)"> 修改机坪</i></el-dropdown-item>
                                <el-dropdown-item><i class="el-icon-delete i_icon" @click="del_Hangar(item.stndObjectId,index)"> 删除机坪</i></el-dropdown-item>                                
                            </el-dropdown-menu>
                        </el-dropdown>                            
                    </div>
                    <transition name="custom-classes-transition" enter-active-class="animated fadeIn">
                                ...
                                <div class="tit">
                                    ...
                                    <el-dropdown trigger="click" :show-timeout='0'  placement="bottom-start">
                                        ...
                                        <el-dropdown-menu slot="dropdown">
                                            ...
                                            <el-dropdown-item><i class="el-icon-delete i_icon" @click="del_reservation(items.stndId,indexs)"> 删除机位</i></el-dropdown-item>
                                        </el-dropdown-menu>
                                    </el-dropdown>
                                </div>
                            </li>                                   
