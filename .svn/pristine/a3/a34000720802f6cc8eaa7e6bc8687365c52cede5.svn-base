    ...
    <el-collapse v-model="activeNames" accordion> 
        <el-collapse-item title="公司资料" name="1">
            <el-form label-position="left" inline label-suffix="：">
                ...
                <el-form-item label="公司类别" class="form-item-2 width130">
                ...
                <el-form-item label="附件" class="form-item-2 width130">
                    <el-button type="text" style="line-height:5px" v-if="company.doc!=null" @click="downloadfile(company.doc,6)">{{company.doc.docName}}</el-button>
                </el-form-item>
        ...
        <el-collapse-item title="证照资料" name="3">
            <el-table class="table table-border table-bg" :data="certificationList" stripe>
                ...
                <el-table-column label="附件">
                    <template slot-scope="scope">
                        <el-button type="text" v-if="scope.row.doc!=null" @click="downloadfile(scope.row.doc,8)">{{scope.row.doc.docName}}</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </el-collapse-item>
        <el-collapse-item title="资质信息" name="4">
            <el-table class="table table-border table-bg" :data="qualificationList" stripe>
                ...
                <el-table-column label="附件">
                    <template slot-scope="scope">
                        <el-button type="text" v-if="scope.row.doc!=null" @click="downloadfile(scope.row.doc,9)">{{scope.row.doc.docName}}</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </el-collapse-item>
