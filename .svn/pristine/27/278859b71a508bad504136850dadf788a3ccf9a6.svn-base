        ...
        <div class="box table-box">
            <div class="topSearchBox">
                ...
                <div class="rbbq">
                    ...
                    <div class="cen">
                        <el-select :value="itfFlgt.flgtArpt" @change="changeArptCode" placeholder="请选择">
                            <el-option
