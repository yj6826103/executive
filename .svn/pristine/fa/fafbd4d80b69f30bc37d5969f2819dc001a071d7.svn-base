  ...
  <div class="Addreservation">
            ...
            <div class="rbbq">
                ...
                <div class="cen">
                    ...
                    <div class="shmBox" style="margin-top: 15px;">
                        <em class="t w2"><i class="el-icon-caret-right"></i>原机位号码</em>
    ...
    <div class="tab-box">
            ...
            <div class="rbbq">
                ...
                <div class="cen">
                    <div class="shmBox">
                        ...
                        <span style="width:25px" v-show="errors.has('stndARule')" class="help is-danger"><i class="el-icon-error"></i></span>
                    </div>
                    <div class="shmBox">
                        <label>离位规则</label>
                        ...
                        <span style="width:25px" v-show="errors.has('stndDRule')" class="help is-danger"><i class="el-icon-error"></i></span>
                    </div>
                    <div class="shmBox">
                        <label>试车</label>
                        ...
                        <span style="width:25px" v-show="errors.has('stndTestRun')" class="help is-danger"><i class="el-icon-error"></i></span>
                    </div>
                </div>
            </div>
            <div class="validateStyle">
            ...
            <div class="rbbq">
                ...
                <div class="cen">
                    <div class="shmBox">                                           
                        ...
                        <span style="width:25px" v-show="errors.has('stndRank1')" class="help is-danger"><i class="el-icon-error"></i></span>
                    </div>                                       
                    <div class="flex1">
                        <div class="shmBox">
                            <em class="t w2">最长机长限制</em>
                            <div style="flex:1">
                                <input v-validate data-vv-rules="required|Number" data-vv-as="最长机长限制" name="stndMaxLength" v-model="stndMaxLength" type="text">
                                <span class="w1">米</span>
                            </div>
                            <span style="width:14px" v-show="errors.has('stndMaxLength')" class="help is-danger"><i class="el-icon-error"></i></span>
                        </div>
                    </div>
                    <div class="flex1">
                        <div class="shmBox">
                            ...
                            <div style="flex:1">
                                <input v-validate data-vv-rules="required|Number" data-vv-as="最长翼展限制" name="stndMaxWidth" v-model="stndMaxWidth" type="text">
                                <span class="w1">米</span>
                            </div>
                            <span style="width:14px" v-show="errors.has('stndMaxWidth')" class="help is-danger"><i class="el-icon-error"></i></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div style="text-align:center;margin-bottom:30px">
            ...
            <el-button v-if="stndPObjectIds==0" type="primary" @click="set_reservation(AddHangarsId)">确  定</el-button>
            <el-button v-else type="primary" @click="set_reservation(unAddHangarsId)">确  定</el-button>            
        </div>                           
  </div>
</template>
