                    ...
                    <div class="infobox">
                      <div class="flexTongJ">
                        ...
                        <div class="rbbq">
                            ...
                            <div class="cen">
                                <input @keyup="toUpperCase" type="text" v-model="comName" class="text" placeholder="请输入"clearable></input>
                            </div>
                        </div>
                        <div class="rbbq">
