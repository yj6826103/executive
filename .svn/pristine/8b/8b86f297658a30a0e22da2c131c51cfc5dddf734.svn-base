<template>
  <div class="seatPlan"><!-- 机位平面状态图 -->
        ...
        <el-dialog 
            ...
            top='15vh'
            width="80%">
            <div class="table-box" style="padding:5px 15px"><!-- 合并单元格 :span-method="spanMethod" -->
                <el-table class="table table-border table-bg" height='380' empty-text='正在加载...' :data="stndFlgtList" >
