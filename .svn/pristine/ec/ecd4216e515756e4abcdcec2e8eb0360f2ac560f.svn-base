<template><!--延时申请统计-->
	<div class="statisticAnalysis">
        <div class="DelayApplyStatisticList">
            <div class="yanqiBox">
                <div class="box">
                    <div class="lbox">
                        <div class="ybq">
                    ...
                    <div class="rbox">
                        <div class="infobox">
                            <div class="flexTongJ">
                                ...
                                <div class="rbbq">
                                    <div class="tit"><i class="el-icon-caret-right"></i>审批日期</div>
                                    <div class="cen">
                                        <el-date-picker v-model="operationDate" type="date" placeholder="选择开始日期" value-format="yyyy-MM-dd"></el-date-picker>
                ...
                <div class="box table-box">
                    <el-table class="table table-border table-bg" :data="dataList" stripe border :row-class-name="tableRowClassName">
                        <el-table-column prop="rn" fixed label="序号" width="50" ></el-table-column>
                        <el-table-column prop="optionTimeChar" label="审批日期" min-width="70" sortable></el-table-column>
                        ...
                        <el-table-column prop="ppParkingDuration" label="延期停场时间"  sortable></el-table-column>
                        <el-table-column prop="ppPpNum" label="延期次数"  sortable></el-table-column>
                        <el-table-column prop="postphoneReason" label="延期原因"  sortable></el-table-column>
